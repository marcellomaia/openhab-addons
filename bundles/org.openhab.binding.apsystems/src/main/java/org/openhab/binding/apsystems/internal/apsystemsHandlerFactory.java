...
public class apsystemsHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Set.of(THING_TYPE_APSYS_ECU);
    private final HttpClientFactory httpClientFactory;

    @Activate
    public apsystemsHandlerFactory(@Reference HttpClientFactory httpClientFactory) {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_APSYS_ECU.equals(thingTypeUID)) {
            return new apsystemsHandler(thing, httpClientFactory.getCommonHttpClient());
        }
